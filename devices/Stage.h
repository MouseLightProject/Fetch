...
namespace device {
  ...
  class IStage
  {
    public:
	  ...
	  inline void  getSafeVelocity(float *vx, float *vy, float *vz)      { getSafeVelocityX(vx); getSafeVelocityY(vy); getSafeVelocityZ(vz); } //DGA: Set safe vx, vy and vz velocities
