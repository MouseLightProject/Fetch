  ...
  ,_defered_update(0)
{
  ...
  _microscopeController		= new MicroscopeController(dc, &_scope_state_controller); //DGA: Dynamically allocate _microsocpeController to point to instance of MicroscopeController class that takes in microscope device dc
