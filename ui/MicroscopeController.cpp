...
{	QCheckBox *skipSurfaceFindOnImageResumeCheckBox = new QCheckBox(parent);  //DGA: Dynamically allocates check box
	...
	connect(&(microscope_->skipSurfaceFindOnImageResumeCheckBoxUpdater), SIGNAL(signal_valueSet(bool)),skipSurfaceFindOnImageResumeCheckBox, SLOT(setChecked(bool)),Qt::QueuedConnection); //DGA: Connect signal_valueSet of microscope_'s skipSurfaceFindOnImageResumeUpdater to setChecked slot so that changing skipSurfaceFindOnImageResume_ will update the checkbox
