...
{	sliceThicknessCorrectionUmLineEdit = new QLineEdit(); //DGA: Dynamically allocate slice thickness correction line edit
	...
	connect(&(vibratome_->sliceThicknessCorrectionUmLineEditUpdater), SIGNAL(signaler(QString)),sliceThicknessCorrectionUmLineEdit, SLOT(setText(QString)),Qt::QueuedConnection); //DGA: Connect the signal signal_valueSet(Qstring) of the thickness correction line edit updater object of vibratome_ to the setText slot of the line edit so the displayed text matches the value of the slice thickness variable of vibratome_
	connect(&(vibratome_->sliceThicknessCorrectionUmLabelUpdater), SIGNAL(signaler(QString)),currentSliceThicknessCorrectionUmLabel, SLOT(setText(QString)),Qt::QueuedConnection); //DGA: Connect the signal signal_valueSet(QString) of the thickness correction label updater object of vibratome_ to the setText slot of the label so the displayed text matches the value of the slice thickness variable of vibratome_
}
