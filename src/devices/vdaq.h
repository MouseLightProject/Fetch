...
namespace vdaq {
  ...
  class AcquisitionEngine : public rdi::DeviceRegisterMap
  {
  public:
    AcquisitionEngine(DeviceRegisterMap *pParent, uint32_t baseAddr) : DeviceRegisterMap(pParent, baseAddr) {};
  ...
  class ClockCfg : public rdi::DeviceRegisterMap
  {
  public:
    ClockCfg(DeviceRegisterMap *pParent, uint32_t baseAddr) : DeviceRegisterMap(pParent, baseAddr) {};
  ...
  class Msadc : public rdi::DeviceRegisterMap
  {
  public:
    Msadc(DeviceRegisterMap *pParent, uint32_t baseAddr) : DeviceRegisterMap(pParent, baseAddr) {};
  ...
  class Device : public rdi::Device
  {
  public:
    Device(int16_t deviceNum, bool designLoadAccess = true);
    ~Device();

    AcquisitionEngine acqEngine;
    ClockCfg clkCfg;
    Msadc msadc;

    vector<ddi::WaveformGenIp*> pWavegenIp;

    vector<rdi::Fifo*> pChannelFifos;
